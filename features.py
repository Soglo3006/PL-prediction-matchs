features_possession = ['Home_avgGoal','Away_avgGoal','Home_avgShot','Away_avgShot', 'Home_avgShot_Target','Away_avgShot_Target'
            , 'home_form','away_form', 'home_advantage','moyenne_domcile_buts','moyenne_exterieur_buts','difference_moyenne_buts_marques',
...
features_match = ['Home_avgGoal','Away_avgGoal','Home_avgShot','Away_avgShot', 'Home_avgShot_Target','Away_avgShot_Target'
            ...
            'moyenne_conceder_dom', 'moyenne_conceder_ext','Home_avgCorner','Away_avgCorner','Home_avgPos','Away_avgPos']

features_tirs =  ['Home_avgGoal','Away_avgGoal','Home_avgShot','Away_avgShot','home_form'
...
features_tirsCadre = ['Home_avgGoal','Away_avgGoal','Home_avgShot','Away_avgShot', 'Home_avgShot_Target','Away_avgShot_Target'
