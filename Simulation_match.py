...
X = fetch_premier_league_data.data_2324[features]
...
a_team = 'Luton'
if h_team != a_team:
    predicted_result = predict_future_match(h_team, a_team, model_home, model_away, fetch_premier_league_data.data_2324)
